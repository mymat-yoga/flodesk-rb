...
Registration and lifecycle of webhook subscriptions. Registration is deliberately coupled to the verification story, because Flodesk signs nothing and the callback URL chosen here determines how authenticity can be established at all.
