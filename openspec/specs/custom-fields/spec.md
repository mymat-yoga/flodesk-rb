...
Custom field definitions: the paginated list, the separate unpaginated list-all endpoint, and creation. Field values are string-typed throughout the API, which constrains every write path that sets them.
